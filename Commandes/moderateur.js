...
module.exports = new Command({
  ...
  name: 'moderateur',
	description: "Permet de promouvoir modérateur un membre du serveur",
  ...
  async run(bot, message, args, interaction) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(`<@${message.user.id}> à promu <@${user.id}> en tant que modérateur du serveur !`)
      .setTimestamp()
      .setFooter({ text: `Antskyyy Bot`, iconURL: 'https://i.imgur.com/DIapvsK.jpg'}) 

      member.roles.add("906194263681949706")
